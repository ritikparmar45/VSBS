...
const Home = () => {
  ...
  const services = [
    { name: 'Oil Change', price: 'From $29', duration: '30 min' },
    { name: 'Brake Service', price: 'From $89', duration: '60 min' },
    { name: 'Engine Diagnostics', price: 'From $59', duration: '45 min' },
    { name: 'AC Service', price: 'From $79', duration: '90 min' },
    { name: 'Tire Rotation', price: 'From $39', duration: '30 min' },
    { name: 'Full Service', price: 'From $199', duration: '120 min' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Your Vehicle's
              <span className="text-blue-200"> Best Friend</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Professional automotive service and repair with convenient online booking. 
